...
<html lang="en">
	...
	<body>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							<li><a href="index.php">Home</a></li>
							<li><a href="store.php?type_id=">All Categories</a></li>
							<li><a href="store.php?type_id=5">Accessories</a></li>
				...
				<div class="row">
					...
					<div id="aside" class="col-md-3">
						...
						<div class="aside">
							...
							<form action="store.php?type_id=<?php echo $type_id?>&soluong=<?php echo $soluong?>" method="post">
									...
									<!-- selected="selected" -->
										...
										<select class="input-select" 
											onchange = 'this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);'>
												...
												value="store.php?type_id=<?php echo $type_id?>&soluong=20" > 20</option>
												
												<option <?php if(isset($_GET['soluong']) && $_GET['soluong'] == "50" ) { ?> selected <?php } ?> 
												value="store.php?type_id=<?php echo $type_id?>&soluong=50" > 50</option>
								...
								if( $type_id != "") {
									if(isset($_POST['checkbox'])){
										foreach($_POST['checkbox'] as $item){
											//var_dump($item);
											$products = $product ->phantrang($type_id,$item,$start_from);
										...
										<?php	endforeach;
											...
											//var_dump($item);
											$products = $product ->phantrangtheoid($type_id,$start_from);
											//var_dump($products);
											foreach($products as $value): ?>
												 <div class="col-md-4 col-xs-6">
													<div class="product">
									...
									if(isset($_POST['checkbox'])){
										foreach($_POST['checkbox'] as $item){
											//var_dump($item);
											$products = $product ->phantrangNotType_id($item,$start_from);
											//$soluong += count($products);
											//var_dump($products);
											foreach($products as $value): ?>
												 <div class="col-md-4 col-xs-6">
										...
										<?php	endforeach;
											...
											//var_dump($item);
											$products = $product ->phantrangNotType_idtheoid($start_from);
											//var_dump($products);
											foreach($products as $value): ?>
												 <div class="col-md-4 col-xs-6">
													<div class="product">
						...
						<div class="store-filter clearfix">
							...
							<ul class="store-pagination">
								...
								$total_pages = ceil($soluong / $per_page_record);
									if($page>=2){ ?>
										<li ><a href='store.php?type_id=<?php echo $type_id ?>&page=<?php echo ($page-1)?>&soluong=<?php echo $soluong?>'>  Prev </a></li>
									<?php };
									for ($i=1; $i<=(int)$total_pages; $i++) {
										if ($i == $page) { ?>
											<li class='active' ><a  href= 'store.php?type_id=<?php echo  $type_id ?>&page=<?php echo $i?>&soluong=<?php echo $soluong?>'><?php echo $i?> </a></li>
										<?php }
										else  { ?>
											<li><a href= 'store.php?type_id=<?php echo $type_id?>&page=<?php echo $i?>&soluong=<?php echo $soluong?>'><?php echo $i?> </a></li>

										<?php }
									};
									if($page < $total_pages ){ ?>

										<li><a href='store.php?type_id=<?php echo $type_id?>&page=<?php echo ($page+1)?>&soluong=<?php echo $soluong?>'>  Next </a></li>
									 <?php };
								?>
							</ul>
						</div>
		...
		<script type = "text/javascript">
			...
			function LayGia() {
				...
				window.location.href = "store.php?type_id=<?php echo $type_id?>&soluong=20" ;
			...
			price_min = getParameterByName('price_min', url);
			price_max = getParameterByName('price_max', url);
			//alert(price_max);
	...
	function updatePriceSlider(elem , value) {
			priceSlider.noUiSlider.set([price_min,  price_max]);
