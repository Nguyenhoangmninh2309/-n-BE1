...
<html lang="en">
				    ...
				    <?php	foreach($products as $value):
						...
						<div class="product-details">
							...
							<ul class="product-btns">
								<li><a href="<?php  ?>"><i class="fa fa-heart-o" onclick=addtowishlist() ?></i> add to wishlist</a></li>
									...
									<div class="row">
										...
										foreach($products as $value):
											...
											//var_dump($detail);
										          ...
										          <h4 style ="text-align: center; color: aqua">Tên: <?php echo $value['name'] ?></h4>
	...
	// 	<?php //addSLWList($value['username'],$value['id']) ?>
	//   }
        </script>
