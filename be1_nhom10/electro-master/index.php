					...
					<?php				 					
						if(isset($_SESSION['user'])){	?>
						         <div class="name dropdown" style ="display: flex;">
							         ...
							         <li><a href='../dangnhap/logout.php'><?php echo "Đăng Xuất"  ?></a>
						         </div>						
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								...
								<a href="store.php?type_id=" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<a class="primary-btn cta-btn" href="store.php?type_id=">Shop now</a>
						</div>
					</div>
				</div>
				<!-- /row -->
