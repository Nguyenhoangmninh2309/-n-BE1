									...
									<div class="product-label">
											...
											<span class="new">NEW</span>
											 ...
											 <div class="sanpham_price">
                                                    ...
                                                    <?php } ?>
													<br>
													<a href="<?php  //delSLWList($value['username'],$value['id']) ?>" class="xoasanpham">Xóa khỏi Wishlist </a>
											 </div>
									     </div>
								    </div>
                               <?php
                                                 endforeach;
                                                  ...
                                                  echo "<h2>Không Tồn Tại Sản Phẩm Trong WishList</h2>";
                                        }?>
		       <div class="back-thanhtoan" style="text-align:center; margin-bottom: 10px;" >
		          <a href="home.php ?>"><button class="add-to-cart-btn"><i class="fa fa-backward"></i> Quay lại</button></a>
		       </div>
